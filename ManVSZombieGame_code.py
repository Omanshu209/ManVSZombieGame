...
win = pygame.display.set_mode((560, 480))
...
win_p = pygame.image.load('assests/bg/win.jpg')
lose_p = pygame.image.load("assests/bg/lose.jpg")

clock = pygame.time.Clock()

score = 0

music = pygame.mixer.music.load("assests/audio/bgmusic2.mp3")
pygame.mixer.music.play(-1)
b_sound = pygame.mixer.Sound("assests/audio/bullet.mp3")
h_sound = pygame.mixer.Sound("assests/audio/hit.mp3")
c_sound = pygame.mixer.Sound("assests/audio/click.mp3")
l_sound = pygame.mixer.Sound("assests/audio/Fail.mp3")
hitm_sound = pygame.mixer.Sound("assests/audio/hitm.mp3")
w_sound = pygame.mixer.Sound("assests/audio/Win.mp3")
...
class enemy(object):
    walkRight = [pygame.image.load('assests/characters/R1E.png'), pygame.image.load('assests/characters/R2E.png'), pygame.image.load('assests/characters/R3E.png'), pygame.image.load('assests/characters/R4E.png'), pygame.image.load('assests/characters/R5E.png'), pygame.image.load(
        'assests/characters/R6E.png'), pygame.image.load('assests/characters/R7E.png'), pygame.image.load('assests/characters/R8E.png'), pygame.image.load('assests/characters/R9E.png'), pygame.image.load('assests/characters/R10E.png'), pygame.image.load('assests/characters/R11E.png')]

    walkLeft = [pygame.image.load('assests/characters/L1E.png'), pygame.image.load('assests/characters/L2E.png'), pygame.image.load('assests/characters/L3E.png'), pygame.image.load('assests/characters/L4E.png'), pygame.image.load('assests/characters/L5E.png'), pygame.image.load(
        'assests/characters/L6E.png'), pygame.image.load('assests/characters/L7E.png'), pygame.image.load('assests/characters/L8E.png'), pygame.image.load('assests/characters/L9E.png'), pygame.image.load('assests/characters/L10E.png'), pygame.image.load('assests/characters/L11E.png')]
...
def redrawGameWindow():
    if score < 100 and score >= -24:
        ...
        win.blit(text11, (20, 150))
        win.blit(text10, (320, 90))
        win.blit(text9, (320, 70))
        win.blit(text8, (20, 130))
        win.blit(text7, (20, 110))
        win.blit(text6, (20, 90))
        win.blit(text5, (20, 70))
        win.blit(text4, (20, 50))
        win.blit(text2, (400, 520))
        win.blit(text3, (20, 30))
        ...
        if len(bullets) < 5:
            bullets.append(
                projectile(
                    ...
                    round(man.y + man.height//2), 6, (255, 255, 100), facing
                )
            )
        shootLoop = 1
